                ...
                <tr>
                    <td class="tdd-container">
                        ...
                        <div class="td-show-details">
                            <ul>
                                <li><label>Name</label>
                                    <div class="tdDetail"><strong>Brooklyn Simmons</strong></div>
                                </li>
                                <li><label>Email</label>
                                    <div class="tdDetail">bill.sanders@example.com</div>
                                </li>
                                <li><label>Gateway</label>
                                    <div class="tdDetail">Paypal</div>
                                </li>
                                <li><label>Class</label>
                                    <div class="tdDetail">Transaction</div>
                                </li>
                            </ul>
                        </div>
                    </td>
                ...
                <tr>
                    <td class="tdd-container">
                        ...
                        <div class="td-show-details">
                            <ul>
                                <li><label>Name</label>
                                    <div class="tdDetail"><strong>Jane Cooper</strong></div>
                                </li>
                                <li><label>Email</label>
                                    <div class="tdDetail">tanya.hill@example.com</div>
                                </li>
                                <li><label>Gateway</label>
                                    <div class="tdDetail">Paypal</div>
                                </li>
                ...
                <tr>
                    <td class="tdd-container">
                        ...
                        <div class="td-show-details">
                            <ul>
                                <li><label>Name</label>
                                    <div class="tdDetail"><strong>Eleanor Pena</strong></div>
                                </li>
                                <li><label>Email</label>
                                    <div class="tdDetail">nathan.roberts@example.com</div>
                                </li>
                                <li><label>Gateway</label>
                                    <div class="tdDetail">Stripe</div>
                                </li>
                                <li><label>Class</label>
                                    <div class="tdDetail">Transaction</div>
                                </li>
                ...
                <tr>
                    <td class="tdd-container">
                        ...
                        <div class="td-show-details">
                            <ul>
                                <li><label>Name</label>
                                    <div class="tdDetail"><strong>Cody Fisher</strong></div>
                                </li>
                                <li><label>Email</label>
                                    <div class="tdDetail">dolores.chambers@example.com</div>
                                </li>
                                <li><label>Gateway</label>
                                    <div class="tdDetail">Stripe</div>
                                </li>
